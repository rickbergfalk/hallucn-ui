...
/**
 * PlankSkeleton - a skeleton loading placeholder that mirrors shadcn/ui Skeleton
 *
 * Uses light DOM so Tailwind classes apply directly.
 * Size is controlled via className (e.g., class="h-4 w-32")
 */
@customElement("plank-skeleton")
export class PlankSkeleton extends LitElement {
