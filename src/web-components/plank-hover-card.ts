...
/**
 * PlankHoverCard - Root container that manages hover card state
 *
 ...
 * ```
 */
@customElement("plank-hover-card")
export class PlankHoverCard extends LitElement {
  ...
  private _trigger: PlankHoverCardTrigger | null = null
  private _content: PlankHoverCardContent | null = null
  private _contentId = `plank-hover-card-content-${++hoverCardId}`
  ...
  private _updateChildren() {
    this._trigger = this.querySelector(
      "plank-hover-card-trigger"
    ) as PlankHoverCardTrigger | null
    this._content = this.querySelector(
      "plank-hover-card-content"
    ) as PlankHoverCardContent | null
...
/**
 * PlankHoverCardTrigger - Element that triggers the hover card on hover/focus
 */
@customElement("plank-hover-card-trigger")
export class PlankHoverCardTrigger extends LitElement {
  private _hoverCard: PlankHoverCard | null = null
  ...
  _setHoverCard(hoverCard: PlankHoverCard) {
...
/**
 * PlankHoverCardContent - The floating hover card content
 */
@customElement("plank-hover-card-content")
export class PlankHoverCardContent extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    "plank-hover-card": PlankHoverCard
    "plank-hover-card-trigger": PlankHoverCardTrigger
    "plank-hover-card-content": PlankHoverCardContent
  }
}
