...
/**
 * PlankToggle - a toggle button web component that mirrors shadcn/ui Toggle
 *
 * Uses light DOM so Tailwind classes apply directly.
 * A button that can be toggled on or off.
 */
@customElement("plank-toggle")
export class PlankToggle extends LitElement {
