...
/**
 * PlankAlertDialog - Root container that manages alert dialog state
 *
 ...
 * ```
 */
@customElement("plank-alert-dialog")
export class PlankAlertDialog extends LitElement {
  @property({ type: Boolean, reflect: true }) open = false

  private _trigger: PlankAlertDialogTrigger | null = null
  private _content: PlankAlertDialogContent | null = null
  private _alertDialogId = `plank-alert-dialog-${++alertDialogId}`
  ...
  private _updateChildren() {
    this._trigger = this.querySelector(
      "plank-alert-dialog-trigger"
    ) as PlankAlertDialogTrigger | null
    this._content = this.querySelector(
      "plank-alert-dialog-content"
    ) as PlankAlertDialogContent | null
...
/**
 * PlankAlertDialogTrigger - Element that triggers the alert dialog on click
 */
@customElement("plank-alert-dialog-trigger")
export class PlankAlertDialogTrigger extends LitElement {
  private _alertDialog: PlankAlertDialog | null = null
  ...
  _setAlertDialog(alertDialog: PlankAlertDialog) {
...
/**
 * PlankAlertDialogContent - The alert dialog content with overlay
 *
 * Unlike regular dialog, clicking the overlay does NOT close the alert dialog.
 */
@customElement("plank-alert-dialog-content")
export class PlankAlertDialogContent extends LitElement {
  ...
  private _showContent() {
    ...
    const title = this._contentEl.querySelector("plank-alert-dialog-title")
    if (title) {
    ...
    this._contentEl
      .querySelectorAll("plank-alert-dialog-action")
...
/**
 * PlankAlertDialogHeader - Header container for title and description
 */
@customElement("plank-alert-dialog-header")
export class PlankAlertDialogHeader extends LitElement {
  @property({ type: String }) class: string = ""
...
/**
 * PlankAlertDialogFooter - Footer container for actions
 */
@customElement("plank-alert-dialog-footer")
export class PlankAlertDialogFooter extends LitElement {
  @property({ type: String }) class: string = ""
...
/**
 * PlankAlertDialogTitle - Alert dialog title
 */
@customElement("plank-alert-dialog-title")
export class PlankAlertDialogTitle extends LitElement {
  @property({ type: String }) class: string = ""
...
/**
 * PlankAlertDialogDescription - Alert dialog description
 */
@customElement("plank-alert-dialog-description")
export class PlankAlertDialogDescription extends LitElement {
  @property({ type: String }) class: string = ""
...
/**
 * PlankAlertDialogAction - Confirm/action button that closes the dialog
 *
 * Has primary button styling by default.
 */
@customElement("plank-alert-dialog-action")
export class PlankAlertDialogAction extends LitElement {
  @property({ type: String }) class: string = ""
...
/**
 * PlankAlertDialogCancel - Cancel button that closes the dialog
 *
 * Has outline button styling by default.
 */
@customElement("plank-alert-dialog-cancel")
export class PlankAlertDialogCancel extends LitElement {
  @property({ type: String }) class: string = ""
...
declare global {
  interface HTMLElementTagNameMap {
    "plank-alert-dialog": PlankAlertDialog
    "plank-alert-dialog-trigger": PlankAlertDialogTrigger
    "plank-alert-dialog-content": PlankAlertDialogContent
    "plank-alert-dialog-header": PlankAlertDialogHeader
    "plank-alert-dialog-footer": PlankAlertDialogFooter
    "plank-alert-dialog-title": PlankAlertDialogTitle
    "plank-alert-dialog-description": PlankAlertDialogDescription
    "plank-alert-dialog-action": PlankAlertDialogAction
    "plank-alert-dialog-cancel": PlankAlertDialogCancel
  }
}
