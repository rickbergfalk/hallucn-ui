...
/**
 * plank-input-otp: Main container that manages the OTP input state
 */
@customElement("plank-input-otp")
export class PlankInputOtp extends LitElement {
  ...
  private _updateSlots() {
    ...
    const slots = this.querySelectorAll("plank-input-otp-slot")
    slots.forEach((slot) => {
      const slotEl = slot as PlankInputOtpSlot
...
/**
 * plank-input-otp-group: Visual grouping for OTP slots
 */
@customElement("plank-input-otp-group")
export class PlankInputOtpGroup extends LitElement {
  createRenderRoot() {
    return this
  }
...
/**
 * plank-input-otp-slot: Individual slot for displaying a single character
 */
@customElement("plank-input-otp-slot")
export class PlankInputOtpSlot extends LitElement {
...
/**
 * plank-input-otp-separator: Visual separator between groups
 */
@customElement("plank-input-otp-separator")
export class PlankInputOtpSeparator extends LitElement {
  createRenderRoot() {
    return this
  }
...
declare global {
  interface HTMLElementTagNameMap {
    "plank-input-otp": PlankInputOtp
    "plank-input-otp-group": PlankInputOtpGroup
    "plank-input-otp-slot": PlankInputOtpSlot
    "plank-input-otp-separator": PlankInputOtpSeparator
  }
}
