...
/**
 * PlankSlider - A slider component for selecting values within a range
 *
 * @fires value-change - Fired when the value changes, with detail: { value: number }
 *
 * @example
 * ```html
 * <plank-slider value="50" min="0" max="100"></plank-slider>
 * ```
 */
@customElement("plank-slider")
export class PlankSlider extends LitElement {
