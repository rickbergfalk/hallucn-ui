...
/**
 * PlankSpinner - A loading spinner web component that mirrors shadcn/ui Spinner
 *
 * Uses light DOM so Tailwind classes apply directly.
 * Renders an animated loading circle icon.
 */
@customElement("plank-spinner")
export class PlankSpinner extends LitElement {
