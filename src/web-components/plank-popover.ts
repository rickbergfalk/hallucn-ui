...
/**
 * PlankPopover - Root container that manages popover state
 *
 ...
 * ```
 */
@customElement("plank-popover")
export class PlankPopover extends LitElement {
  @property({ type: Boolean, reflect: true }) open = false

  private _trigger: PlankPopoverTrigger | null = null
  private _content: PlankPopoverContent | null = null
  private _contentId = `plank-popover-content-${++popoverId}`
  ...
  private _updateChildren() {
    this._trigger = this.querySelector(
      "plank-popover-trigger"
    ) as PlankPopoverTrigger | null
    this._content = this.querySelector(
      "plank-popover-content"
    ) as PlankPopoverContent | null
...
/**
 * PlankPopoverTrigger - Element that triggers the popover on click
 */
@customElement("plank-popover-trigger")
export class PlankPopoverTrigger extends LitElement {
  private _popover: PlankPopover | null = null
  ...
  _setPopover(popover: PlankPopover) {
...
/**
 * PlankPopoverContent - The floating popover content
 */
@customElement("plank-popover-content")
export class PlankPopoverContent extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    "plank-popover": PlankPopover
    "plank-popover-trigger": PlankPopoverTrigger
    "plank-popover-content": PlankPopoverContent
  }
}
